...
impl MessageHeaders {
    //pub fn new(type_: /*Ignored*/MessageHeadersType) -> MessageHeaders {
    //    unsafe { TODO: call soup_sys:soup_message_headers_new() }
    //}
    ...
    //pub fn get_headers_type(&mut self) -> /*Ignored*/MessageHeadersType {
    //    unsafe { TODO: call soup_sys:soup_message_headers_get_headers_type() }
    //}
